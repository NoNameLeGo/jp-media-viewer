...
Debug：`android/app/build/outputs/apk/debug/jp-media-viewer-beta0.1.5-fix-debug.apk`；Release：`android/app/build/outputs/apk/release/jp-media-viewer-beta0.1.5-fix-release.apk`
