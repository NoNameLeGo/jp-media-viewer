...
Debug：`android/app/build/outputs/apk/debug/jp-media-viewer-beta0.0.8-debug.apk`；Release：`android/app/build/outputs/apk/release/jp-media-viewer-beta0.0.8-release.apk`
