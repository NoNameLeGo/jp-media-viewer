...
Debug：`android/app/build/outputs/apk/debug/jp-media-viewer-beta0.1.5-crashfix-test-debug.apk`；Release：`android/app/build/outputs/apk/release/jp-media-viewer-beta0.1.5-crashfix-test-release.apk`
