...
Debug：`android/app/build/outputs/apk/debug/jp-media-viewer-beta0.1.0-debug.apk`；Release：`android/app/build/outputs/apk/release/jp-media-viewer-beta0.1.0-release.apk`
